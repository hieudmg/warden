...
# <connection>/<database> targets with host/database metadata. Search is
# word-based, typo-tolerant, and ranks results independently in each section;
# partial matches remain visible below stronger matches.
